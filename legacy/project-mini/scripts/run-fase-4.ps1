...
$comandos = @(
    @{
        Descricao = "FASE 4: Verificação de Sintaxe (cargo check)"
        Comando = "D:\app\dev\rust\cargo\bin\cargo.exe check --workspace"
        LogFile = "D:\proj\mini\project-mini\logs\fase4-cargo-check.log"
    },
    @{
        Descricao = "FASE 4: Testes Unitários (cargo test)"
        Comando = "D:\app\dev\rust\cargo\bin\cargo.exe test --workspace"
        LogFile = "D:\proj\mini\project-mini\logs\fase4-cargo-test.log"
    },
    @{
        Descricao = "FASE 4: Lint (cargo clippy --workspace -- -D warnings)"
        Comando = "D:\app\dev\rust\cargo\bin\cargo.exe clippy --workspace -- -D warnings"
        LogFile = "D:\proj\mini\project-mini\logs\fase4-cargo-clippy.log"
    }
)
