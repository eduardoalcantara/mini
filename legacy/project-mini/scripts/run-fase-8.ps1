...
$comandos = @(
    @{
        Descricao = "FASE 8: Verificação de Sintaxe (cargo check)"
        Comando = "D:\app\dev\rust\cargo\bin\cargo.exe check --workspace"
        LogFile = "D:\proj\mini\project-mini\logs\fase8-cargo-check.log"
    },
    @{
        Descricao = "FASE 8: Testes Unitários (cargo test)"
        Comando = "D:\app\dev\rust\cargo\bin\cargo.exe test --workspace"
        LogFile = "D:\proj\mini\project-mini\logs\fase8-cargo-test.log"
    },
    @{
        Descricao = "FASE 8: Compilação Release Final (cargo build --release)"
        Comando = "D:\app\dev\rust\cargo\bin\cargo.exe build --release"
        LogFile = "D:\proj\mini\project-mini\logs\fase8-cargo-build-release.log"
    }
)
