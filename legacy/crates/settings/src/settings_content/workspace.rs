...
pub struct WorkspaceSettingsContent {
    ...
    /// Whether to enable the system tray icon functionality.
    /// When enabled, minimizing the window will hide it from the taskbar and show it in the system tray.
    /// This setting only applies on Windows and is ignored on other platforms.
    ///
    /// Default: true
