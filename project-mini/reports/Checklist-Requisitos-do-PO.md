...
- [ ] As tarefas de listas de compras funciona exatamente como as tarefas simples, mas já vêm com a tag `compras` e o usuário pode opcionalmente colocar a descrição, ENTER, e colocar mais tags, como por exemplo `casa`, `carro`, `ferramenta` etc.
